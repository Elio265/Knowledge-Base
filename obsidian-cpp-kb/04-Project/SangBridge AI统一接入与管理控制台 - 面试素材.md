---
tags: [project, sangbridge, interview, personal-contribution, vcs]
status: 面试重点
created: 2026-08-13
updated: 2026-08-13
---

# SangBridge AI统一接入与管理控制台 - 面试素材

> **视角**：VCS 个人贡献视角——作者在内网代码中的具体改动。
> **本笔记用途**：准备社招面试时引用个人成果、TD 编号、提交哈希、测试用例行号等事实证据。
> **项目级理解**（架构、模块、机制、边界）见 [[SangBridge AI统一接入与管理控制台]]。
...
- [[SangBridge AI统一接入与管理控制台]]：整个项目视角的主笔记（架构、模块、机制）
- [[项目知识地图]]
